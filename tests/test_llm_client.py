...
class TestOpenRouterClient(unittest.TestCase):
    ...
    def test_mock_fallback_when_no_key(self):
        cfg = Config(openrouter_api_key="", llm_model_extract="google/gemini-2.5-flash")
    ...
    def test_config_model_override(self):
        ...
        client = OpenRouterClient(config=cfg)
        response = client.complete("Hello", model="deepseek/deepseek-v4-flash")
        self.assertIn("deepseek/deepseek-v4-flash", response)
